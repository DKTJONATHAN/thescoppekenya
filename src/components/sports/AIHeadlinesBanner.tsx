...
export function AIHeadlinesBanner() {
  ...
  return (
    <div className="bg-zinc-900/40 border border-zinc-800 rounded-[2.5rem] p-10 relative overflow-hidden group shadow-2xl backdrop-blur-sm">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl opacity-50 group-hover:scale-150 transition-transform duration-700" />
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-8">
          ...
          <Button
            ...
            className="text-zinc-500 hover:text-primary hover:bg-primary/10 rounded-full transition-all"
          >
          ...
          <div>
            ...
            {currentHeadline.match && (
              <div className="pt-6 border-t border-zinc-800 flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">
                ...
                <span className="px-3 py-1 bg-zinc-800 rounded-lg text-primary font-black">
