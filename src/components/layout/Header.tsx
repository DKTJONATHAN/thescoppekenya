            ...
            <nav className="hidden lg:flex items-center gap-0.5">
              {primaryNavLinks.map((link) => (
                <Link
                  ...
                  className={
                    link.featured
                      ? "flex items-center gap-1.5 px-3 py-2 text-sm font-bold text-primary hover:bg-primary/10 rounded-lg transition-all"
                      : "px-3 py-2 text-sm font-semibold text-foreground hover:text-primary hover:bg-primary/5 rounded-lg transition-all"
                  }
                >
                  {link.featured ? <Flame className="w-4 h-4" /> : null}
                  {link.label}
                </Link>
              ))}
            ...
            <div className="container py-4 space-y-1">
              {primaryNavLinks.map((link) => (
                <Link
                  ...
                  className={
                    link.featured
                      ? "flex items-center gap-2 px-4 py-3 text-primary hover:bg-primary/10 rounded-lg transition-smooth font-bold"
                      : "block px-4 py-3 text-foreground hover:text-primary hover:bg-primary/5 rounded-lg transition-smooth font-medium"
                  }
