...
### Digital Transparency Drives Revenue Growth

Launched in 2004, KRA's iWhistle web portal provides an anonymous channel for reporting financial misconduct, including tax fraud, bribery, and abuse of office. This digital innovation bypasses previous requirements for self-identification, which historically deterred whistleblowers. Each report generates a unique tracking code, ensuring informants can monitor progress while maintaining anonymity until the financial payout stage. This enhanced user experience directly contributes to the significant KES 6.8 billion in recovered taxes recorded for the financial year concluded June 2025, a substantial jump from KES 4.22 billion the year prior. Despite fewer cases filed-821 compared to 883-the higher recovery figure indicates an improvement in the quality and impact of the intelligence gathered.

### Incentivized Reporting and Internal Accountability

The iWhistle platform incorporates a robust incentive structure. Whistleblowers are eligible for 5% of successfully recovered taxes, capped at KES 5 million per case. For tips leading to the identification of previously unassessed taxes, a 1% payout applies, capped at KES 500,000. This financial motivation encourages public participation in upholding tax compliance. Beyond external fraud, iWhistle serves as a powerful tool for internal integrity. Forty-five KRA staff faced disciplinary action following reports from the platform in the last review period alone. In the year to June 2024, 255 employees were investigated, 41 underwent lifestyle audits, and over 2,100 background checks were initiated, largely triggered by insider intelligence.
