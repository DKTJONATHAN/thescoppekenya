...
### Addressing Payroll Anomalies

The Teachers Service Commission has indicated that many teachers may experience salaries being sent to incorrect stations due to administrative errors following ongoing mass transfers. Such cases are not uncommon within TSC payroll procedures and typically arise from changes in deployment, station transfers, or data mismatches in the payroll system. When a salary is misdirected, the funds are not lost; they are redirected back to the commission’s central processing unit for verification. Returned salaries are received by the Revenue Division at the TSC headquarters, which is responsible for handling payroll corrections and resolving payment anomalies.

### Teacher Notification and Verification Process

Teachers affected by a misdirected salary are required to formally notify the TSC through their respective county or sub-county offices. This notification must include proof of employment and current station details. Once the complaint is lodged, the matter is escalated to the Revenue Division, which then conducts an internal review to confirm whether the salary was indeed misdirected or returned. If the investigation confirms that the salary was returned due to genuine administrative reasons, the TSC initiates the process of reprocessing the payment to the correct station or account.
