...
Authorised Facilities and Accessibility The newly published list details health centres approved to conduct these essential medical examinations across the country. Key locations include Nairobi's Industrial Area, Upper Hill, Kilimani, Ngara, South B, Westlands, and Nairobi West. Beyond the capital, facilities are also listed in major towns such as Mombasa, Kisumu, Nakuru, Eldoret, and Laikipia. This widespread distribution is intended to improve accessibility for drivers and other motorists, reducing the need for long-distance travel to undergo assessments. Drivers are strictly advised to utilise only the facilities appearing on this official list.

Scope of Medical Evaluations The medical evaluations conducted at these authorised centres assess a driver's overall physical health comprehensively. This includes critical aspects such as vision acuity, hearing capabilities, and the presence of any other medical conditions that could potentially impair their ability to operate a motor vehicle safely. The NTSA emphasises that only practitioners from the published list are qualified and authorised to perform these examinations, ensuring the integrity and validity of the assessments.
