...
Accelerated Message Disappearance This upcoming feature builds on WhatsApp's current disappearing messages, which offer fixed timers of 24 hours, 7 days, or 90 days. The "After Reading" system is specifically engineered for messages requiring a much faster deletion cycle. It provides users with heightened control over their digital conversations, especially when transmitting sensitive data like one-time passwords, addresses, and verification codes.

Independent of Read Receipts The functionality of "After Reading" is designed to operate even when read receipts are disabled. Despite users potentially turning off blue ticks for privacy, the new feature will still detect when a message is opened, triggering the 15-minute deletion timer regardless. This maintains the integrity of the ephemeral message system.
