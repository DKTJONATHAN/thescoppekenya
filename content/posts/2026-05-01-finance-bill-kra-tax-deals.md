...
### Anti-Avoidance Measures Strengthened

Under the new framework, KRA will be able to scrutinise transactions and commercial setups suspected of reducing tax liability in a manner inconsistent with their true economic substance. A key provision introduces an anti-tax avoidance rule, empowering the KRA Commissioner General to disregard arrangements found to be primarily designed for a tax advantage. This means companies and individuals must now consider both the legal form and the actual intent and impact of their transactions. The authority can effectively ignore a tax-reducing transaction and recalculate tax based on what the deal would have been without such an arrangement.

### Expanded Enforcement Powers

KRA will now leverage diverse data sources to bolster its enforcement capabilities. This includes information from tax returns, audits, electronic tax systems, customs inspections, and financial reporting platforms. The taxman will issue assessments based on data gathered from multiple systems, reinforcing a data-driven approach to enforcement. The Finance Bill 2026 also introduces new definitions of tax avoidance, enabling KRA to examine both formal and informal arrangements designed to reduce tax, secure refunds, or delay payments. Where such schemes are identified, KRA can issue revised tax assessments within a five-year window, providing a long enforcement period to recover unpaid taxes.

### Pre-emptive Assessments and Verifiable Data
