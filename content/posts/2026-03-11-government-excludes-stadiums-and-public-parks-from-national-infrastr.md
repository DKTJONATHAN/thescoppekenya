...
Alternative Financing for Public Goods Instead of NIF financing, initiatives for public parks and stadiums will be funded through traditional government budgets, donor grants, or other public funding mechanisms. This approach ensures these vital social projects can proceed without compromising the NIF's core financial objectives.

Profitable Ventures Under NIF The National Infrastructure Fund is designed to finance projects deemed "bankable" due to their potential to generate consistent returns. Eligible projects include airports, toll highways, energy projects, and logistics infrastructures. These ventures are expected to generate revenue through charges such as landing fees, cargo handling, and commercial operations, particularly in the case of airports. The expansion of Jomo Kenyatta International Airport (JKIA) has been identified as the inaugural project to be financed by the fund.
