...
Addressing Initial Misinterpretations The clarification from the IEBC comes after public debate sparked by earlier communication that was interpreted by some as suggesting a sweeping re-registration drive for all individuals who enrolled as voters prior to 2012. This initial wording triggered fears that older voter data had been invalidated. The electoral body has now stressed that there is no cause for alarm, confirming the directive targets only a small group of eligible voters who missed the 2012 biometric registration and have not registered since.

Evolution of the Voter Register The current Register of Voters (RoV) was established following the promulgation of the Constitution in 2010 and subsequent electoral reforms. A key change was the introduction of biometric voter registration in 2012, marking a shift from the previous manual system to a more secure and verifiable digital database. Before 2012, voter registration was conducted manually, and those records are not integrated into the current biometric system unless individuals re-registered under the new framework. Consequently, only those who failed to transition to the biometric system are required to register afresh.
