...
NAMES = {
    ...
    "za Entertainment.yml": "Entertainment | Mutheu Ann ← ew.com",
    "za ghafla.yml": "Gossip | Wanjiku Kuria ← ghafla.co.ke",
    "za mpasho.yml": "Showbiz | Martin Kihara ← mpasho.co.ke",
    "za sports.yml": "Sports | Jona Munyi ← bbc.com/sport/football",
    ...
    "za-entertainment-hourly.yml": "Dispatcher | Hourly Entertainment → Mutheu Ann",
