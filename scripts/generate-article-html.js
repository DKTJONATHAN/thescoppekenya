...
/**
 * Generates prerendered HTML files for each article at dist/client/article/{slug}/index.html
...
async function getDistIndexHtml() {
  // UPDATED: Points to dist/client/index.html generated by SSR build
  const distIndex = path.resolve(process.cwd(), 'dist/client/index.html');
  try {
...
async function main() {
  ...
  for (const post of posts) {
    // UPDATED: Writes to dist/client instead of dist
    const articleDir = path.resolve(process.cwd(), `dist/client/article/${post.slug}`);
